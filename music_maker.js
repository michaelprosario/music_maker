...
var DemoPatterns = (function () {
    function DemoPatterns() {
    }
    DemoPatterns.prototype.AddPickingPattern_4_1 = function (track, aChord) {
    ...
    DemoPatterns.prototype.AddPickingPattern_4_2 = function (track, aChord) {
        var intRoot = aChord[0];
    ...
    DemoPatterns.prototype.AddPickingPattern_4_3 = function (track, aChord) {
        var intRoot = aChord[0];
        var intMiddle = aChord[1];
        var intFifth = aChord[2];
        var intRoot2 = aChord[0] + 12;
    ...
    DemoPatterns.prototype.AddPickingPattern_4_4 = function (track, aChord) {
        var intRoot = aChord[0] - 24;
        track.addNote(0, intRoot, beat * 3);
        track.addNote(0, intRoot, beat * 1);
    };
    DemoPatterns.prototype.AddPickingPattern_4_5 = function (track, aChord) {
        var intRoot = aChord[0];
